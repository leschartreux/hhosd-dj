...
SECRET_KEY = 'vhbrehe=^##m25#13sib_w(=8f4cie=qrpwlbhblph!gd!r!7y'
...
WSGI_APPLICATION = 'hhosd-dj.wsgi.application'
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR),"static_env","website","static")
